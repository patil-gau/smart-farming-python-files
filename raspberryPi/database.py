...
cursor.execute("CREATE TABLE IF NOT EXISTS sensor_value(id INTEGER PRIMARY KEY AUTO_INCREMENT, moisture_value int NOT NULL, ld_value int NOT NULL, temp_value float NOT NULL,motar_state VARCHAR(10) NOT NULL,light_state VARCHAR(10) NOT NULL, fan_state VARCHAR(10) NOT NULL)")
